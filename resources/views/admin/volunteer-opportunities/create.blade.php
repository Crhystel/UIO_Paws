{{-- resources/views/admin/volunteer-opportunities/create.blade.php --}}
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="text-center mb-4">
                 <h1 class="hero-title h2 mb-0">Crear Nueva Oportunidad</h1>
                 <p class="text-muted">Define un nuevo rol para que los voluntarios puedan ayudar.</p>
            </div>
