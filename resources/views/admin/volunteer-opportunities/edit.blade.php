{{-- resources/views/admin/volunteer-opportunities/edit.blade.php --}}
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
             <div class="text-center mb-4">
                 <h1 class="hero-title h2 mb-0">Editar Oportunidad</h1>
                 <p class="text-muted fst-italic">"{{ $opportunity['title'] }}"</p>
            </div>
