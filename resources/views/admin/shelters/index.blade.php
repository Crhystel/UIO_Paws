{{-- resources/views/admin/shelters/index.blade.php --}}
...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="hero-title h2 mb-0">Gestión de Refugios</h1>
        <a href="{{ route('admin.shelters.create') }}" class="btn-cta">Añadir Refugio</a>
    </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    @forelse ($shelters as $shelter)
                        <tr>
                            <td class="fw-bold">{{ $shelter['shelter_name'] }}</td>
                            <td>{{ $shelter['contact_email'] }}</td>
                            <td>{{ $shelter['phone'] }}</td>
                            <td class="text-end">
                                <a href="{{ route('admin.shelters.edit', $shelter['id_shelter']) }}" class="btn btn-sm btn-outline-warning rounded-pill fw-bold">Editar</a>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center text-muted py-4">No hay refugios registrados.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
