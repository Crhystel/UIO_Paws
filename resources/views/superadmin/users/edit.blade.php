...
<!-- ========================================== -->
<!-- ESTILOS VISUALES (Mismo sistema de diseño) -->
<!-- ========================================== -->
...
<style>
    ...
    .feature-card .form-control, .feature-card .form-select {
        border-radius: 50px; padding: 12px 20px; border: 1px solid #e0e0e0;
        background-color: #fcfcfc; margin-bottom: 15px;
    }
    .feature-card .form-control:focus, .feature-card .form-select:focus {
        border-color: var(--color-verde-principal);
        box-shadow: 0 0 0 4px rgba(116, 198, 157, 0.15);
        background-color: white;
    }
    .feature-card label {
        font-weight: 600; font-size: 0.9rem; margin-bottom: 8px; margin-left: 10px;
        color: var(--color-verde-oscuro);
    }
    ...
    .btn-cta:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(116, 198, 157, 0.6); color: white; }

    .btn-secondary-custom {
        background-color: transparent; border: 2px solid #ddd;
        color: #777; padding: 10px 25px; border-radius: 50px;
        font-weight: 600; text-decoration: none; transition: all 0.3s ease; display: inline-block;
    }
    .btn-secondary-custom:hover { border-color: var(--color-verde-oscuro); color: var(--color-verde-oscuro); background-color: white; }
...
<div class="container py-5 position-relative" style="z-index: 1;">
    ...
    <div class="text-center mb-5">
        <h1 class="page-title display-5 mb-2">
            Editar <span class="highlight-shape">Usuario</span>
        </h1>
        <p class="text-muted">
            Actualizando datos de: <strong style="color: var(--color-acento);">{{ $user['first_name'] }} {{ $user['last_name'] }}</strong>
        </p>
    </div>
